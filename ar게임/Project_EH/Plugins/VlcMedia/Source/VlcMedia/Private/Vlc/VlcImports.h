...
typedef void (*FLibvlcMediaAddOptionProc)(FLibvlcMedia* /*Media*/, const ANSICHAR* /*Argv*/);
...
typedef int (*FLibvlcAudioSetDelayProc)(FLibvlcMediaPlayer* /*Player*/, int64 /*delay*/);
